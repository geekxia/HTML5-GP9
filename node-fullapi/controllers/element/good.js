...
class GoodController {
  ...
  static async getGoodList(ctx) {
    ...
    console.log('----_id', _id)
    // 默认给商家使用的
    let { name, cate, page, size, min_price, max_price, check_status } = ctx.request.query
    ...
    // 如果前端传递的审核状态不是 0/1/-1，这个参数不参与查询
    if(params.check_status===undefined || params.check_status==='') delete params.check_status
